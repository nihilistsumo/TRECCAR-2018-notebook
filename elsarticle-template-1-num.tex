...
\begin{table}
\centering
\caption{Performance of passage retrieval methods. Y1 Train and Y1 Test benchmarks are derived from an automatically generated ground truth. The Y2 Test benchmark contains the TREC 2018 manual assessments.\label{tab:psg-results} }
\resizebox{\columnwidth}{!}{%
    \begin{tabular}{llllllllll}\toprule 
        ...
        sectionPath-bm25-none & 0.14                 & 0.11                   & 0.26                  & 0.13                & 0.10                  & 0.25               & --                     & --                       & --                      \\ 
        sectionPath-ql-none   & 0.13                 & 0.10                   & 0.25                  & 0.13                & 0.10                  & 0.25               & --                     & --                       & --                      \\ 
        sectionPath-ql-rm     & 0.08                 & 0.05                  & 0.24                  & 0.08               & 0.06                 & 0.20               & --                     & --                       & --                      \\ 
        sectionPath-bm25-rm   & 0.11                 & 0.08                  & 0.24                  & 0.11                & 0.09                 & 0.24               & --                     & --                       & --                      \\ \bottomrule
    \end{tabular}
    }
\label{tab:passage}
\end{table}
